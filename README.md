...
1. トップページから"航空機材一覧画面"へと遷移することで、機材一覧ページへと遷移します。
   機材名をクリックすることで、機材の詳細画面へと遷移する事ができます。
...
![新規登録](app/assets/images/check_in.gif)

ログインをする場合には、emailアドレス及びpasswordの入力を行う様に実装を行いました。

![ログイン](app/assets/images/login.gif)
...
![検索機能](app/assets/images/search.gif)

ログインせずに検索ボタンをクリックした場合は、ログイン画面へと遷移する様に設定しています。

![ログインしていない場合](app/assets/images/logout.gif)
...
![航空会社一覧ページ](app/assets/images/search_view.gif)


![航空会社HP遷移](app/assets/images/page.gif)


### 航空機材一覧
航空機材一覧画面の実装を行いました。
機能としては、テーブルにて機材の3レターと機材名の表示を行い、クリックをすると航空機材の詳細ページへと遷移する様に実装しました。

![航空機材一覧ページ](app/assets/images/airplane_index.gif)


![詳細ページ遷移](app/assets/images/airplane_show.gif)
